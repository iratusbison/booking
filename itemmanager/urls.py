...
from itemmanager.views.view_aksinn import add_room, room_list, book_room, edit_booking, delete_booking, generate_pdf_book, booking_detail, booking_list, generate_bill
